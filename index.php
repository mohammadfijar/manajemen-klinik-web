                ...
                <div class="row">
                    ...
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="#contact_us">Kontak Kami</a></li>
                            <li><a href="#logins">Logins</a></li>  
                            
                        </ul>
                    </div>
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="hms/user-login.php">Janji Temu</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item ">
                ...
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Klinik Kita 35</h5>
                </div>
            </div>
                        ...
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Klik Disini</button>
                                </a>
                            </div>
                        </div>
                    </div>
...
<section id="services" class="key-features department">
    <div class="container">
        <div class="inner-title">
            <h2>Services</h2>
            <p>Beberapa Layanan Utama Kami</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-key">
                    ...
                    <h5>Poli Umum</h5>
                    <p>Konsultasi kesehatan dasar.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-key">
                    ...
                    <h5>Poli Gigi</h5>
                    <p>Pemeriksaan dan perawatan gigi dan mulut.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-key">
                    ...
                    <h5>Apotek</h5>
                    <p>Penyediaan obat-obatan resep dokter.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-key">
                    ...
                    <p>Penanganan pasien darurat sementara.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-key">
                   <i class="fas fa-microscope"></i>
                    <h5>Laborarotium</h5>
                    <p>Pemeriksaan penunjang diagnosis.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="gallery-filter d-none d-sm-block">
                ...
                <button class="btn btn-default filter-button" data-filter="hdpe">Poli Gigi</button>
                <button class="btn btn-default filter-button" data-filter="sprinkle">Poli Umum</button>
                <button class="btn btn-default filter-button" data-filter="spray">Poli Kebidanan</button>
                <button class="btn btn-default filter-button" data-filter="irrigation">Laboratorium</button>
            </div>
            <br/>
...
<section id="contact_us" class="contact-us-single">
    <div class="row no-margin">
        <div class="col-sm-12 cop-ck">
            <form method="post" id="contactForm">
                <h2>Kontak Form</h2>
                <div class="row cf-ro">
                    <div class="col-sm-3"><label for="fullname">Masukkan Nama:</label></div>
                ...
                <div class="row cf-ro">
                    <div class="col-sm-3"><label for="mobileno">Nomor Telepon:</label></div>
                ...
                <div class="row cf-ro">
                    <div class="col-sm-3"><label for="description">Masukkan Pesan:</label></div>
                    <div class="col-sm-8">
                ...
                <div class="row cf-ro">
                    ...
                    <div class="col-sm-8">
                        <button class="btn btn-success btn-sm" type="submit" name="submit">Kirim Pesan</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <ul class="list-unstyled link-list">
        <li><a ui-sref="about" href="#about_us">Tentang Kami</a><i class="fa fa-angle-right"></i></li>
        ...
        <li><a ui-sref="contact" href="#contact">Kontak Kami</a><i class="fa fa-angle-right"></i></li>
    </ul>
</div>
                <div class="col-md-6 col-sm-12 map-img">
                    <h2 style="font-family: 'Times New Roman', Times, serif; color: white; text-decoration: underline;"><b>Kontak Kami</b></h2>
...
?>
                        ...
                        Jadwal Buka: <?php  echo $row['OpenningTime'];?>
                    </address>
        <?php } ?>
                </div>
            </div>
